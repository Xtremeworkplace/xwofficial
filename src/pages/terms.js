...
const terms = () => {
  return (
    ...
    <article class="rose dark:prose-invert">

    <p> Terms and Conditions WEBSITE TERMS AND CONDITIONS | Last updated 1 Jan 2022</p>

<p>AGREEMENT TO TERMS</p>

<p>These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&amp; you) and Xtreme Workplace (Lanista Educational Services (OPC) Pvt. Ltd.) (&amp; we, &amp; us or &amp; our), concerning your access to and use of the Xtremeworkplace.in the website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the &amp; Site).</p>
...
<p>We have the right, in our sole and absolute discretion, (1) to edit, redact, or otherwise change any Contributions; (2) to re-categorize any Contributions to place them in more appropriate locations on the Site; and (3) to pre-screen or delete any Contributions at any time and for any reason, without notice. We have no obligation to monitor your Contributions. GUIDELINES FOR REVIEWS</p>
...
<p>Apple and Android Devices The following terms apply when you use a mobile application obtained from either the Apple Store or Google Play (each an &amp; App Distributor) to access the Site:</p>
...
<p>(4) you represent and warrant that (i) you are not located in a country that is subject to Indian government embargo, or that has been designated by the Indian government as a &amp; terrorist supporting country and (ii) you are not listed on any Indian government list of prohibited or restricted parties;</p>
...
<p>6) you acknowledge and agree that the App Distributors are third-party beneficiaries of the terms and conditions in this mobile application license contained in these Terms and Conditions, and that each App Distributor will have the right (and will be deemed to have accepted the right) to enforce the terms and conditions in this mobile application license contained in these Terms and Conditions against you as a third-party beneficiary thereof. SOCIAL MEDIA</p>
...
<p>We care about data privacy and security. Please review our Privacy Policy. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms and Conditions. Please be advised the Site is hosted in the India.</p>

<p>If you access the Site from the European Union, Asia, or any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the India, then through your continued use of the Site, you are transferring your data to the India, and you expressly consent to have your data transferred to and processed in the India.</p>

<p>[Further, we do not knowingly accept, request, or solicit information from children or knowingly market to children. Therefore, in accordance with the Indian Children&rsquo;s Online Privacy Protection Act, if we receive actual knowledge that anyone under the age of 13 has provided personal information to us without the requisite and verifiable parental consent, we will delete that information from the Site as quickly as is reasonably practical.] DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY Notifications</p>
...
<p>All Notifications should meet the requirements of DMCA and include the following information:</p>
...
<p>(2) a statement that you consent to the jurisdiction of the Federal District Court in which your address is located, or if your address is outside the India, for any judicial district in which we are located;</p>

<p>(3) a statement that you will accept service of process from the party that filed the Notification or the party&rsquo;s agent;</p>
...
<p>If you send us a valid, written Counter Notification meeting the requirements described above, we will restore your removed or disabled material, unless we first receive notice from the party filing the Notification informing us that such party has filed a court action to restrain you from engaging in infringing activity related to the material in question. Please note that if you materially misrepresent that the disabled or removed content was removed by mistake or misidentification, you may be liable for damages, including costs and attorney&rsquo;s fees. Filing a false Counter Notification constitutes perjury.</p>

<p>Designated Copyright Agent [Vikram@xtremeworkplace.in] Attn: Copyright Agent [Delhi , India , 110044] [email : vikram@xtremeworkplace.in]</p>
...
<p>These Terms and Conditions and your use of the Site are governed by and construed in accordance with the laws of the State of Delhi applicable to agreements made and to be entirely performed within the State/Commonwealth of Delhi, without regard to its conflict of law principles.</p>

<p>DISPUTE RESOLUTION Informal Negotiations To expedite resolution and control the cost of any dispute, controversy, or claim related to these Terms and Conditions (each a Dispute and collectively, the &amp; Disputes) brought by either you or us (individually, a &amp; Party and collectively, the &amp; Parties), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least 30 days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.</p>
...
<p>AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE. LIMITATIONS OF LIABILITY</p>
...
<p>Notwithstanding the foregoing, we reserve the right, at your expense, to assume the exclusive defense and control of any matter for which you are required to indemnify us, and you agree to cooperate, at your expense, with our defense of such claims. We will use reasonable efforts to notify you of any such claim, action, or proceeding which is subject to this indemnification upon becoming aware of it. USER DATA</p>
...
<p>You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</p>
...
<p>[Lanista Educational Services Opc Private Limited] [Delhi , India , 110044] [Email Address: Admin@xtremeworkplace.in]</p>

...
const IndexPage = () => (
  <Layout>
    ...
    <Seo title="Business Community| Super Network " 
    description="Every business needs extra attention to grow sales & revenue therefore we are introducing super network more than business community."
    keywords="business community, xtreme workplace community, xtreme workplace, 
      ...
      <div className="relative flex justify-end max-w-xl mx-auto xl:pr-32 lg:max-w-screen-xl">
        <div className="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
          <div className="max-w-xl mb-6">
            <div>
              <p className="inline-block px-3 py-px mb-4 text-xl font-semibold text-xl tracking-wider text-gray-900 uppercase rounded-full bg-amber-700">
                Super Network
              </p>
            </div>
            ...
            <p className="text-lg text-gray-900 md:text-xl">
              Every business needs extra attention to grow sales & revenue therefore we are introducing super network more than business community.
            </p>
          </div>
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
          <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
            <Link to="/network" className="mb-6 sm:mx-auto">

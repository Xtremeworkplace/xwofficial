      ...
      <div className="grid gap-5 row-gap-8 lg:grid-cols-2">
        <div className="flex flex-col justify-center">
          ...
          <Link
            to="tel:+918383066031"
            aria-label=""
            className="inline-flex items-center text-xl font-semibold text-xl transition-colors duration-200 text-amber-900 hover:text-amber-700"
          >
            Book a Call
            <svg
...
<div className="bg-indigo-accent-700">
    ...
    <div className="bg-pink-accent-400">
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
          <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            ...
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              ...
              Get the gist of xtreme workplace with a guided, B.S.-free tour.
              </p>
            </div>
            <div>
              <Link
                href="tel:+918383066031"
                className="inline-flex items-center justify-center h-12 px-6 font-semibold tracking-wide text-white transition duration-200 rounded shadow-md hover:text-black bg-black hover:bg-white focus:shadow-outline focus:outline-none"
              >
               Book a Call
              </Link>
            </div>

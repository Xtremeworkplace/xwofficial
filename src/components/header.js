          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  <Link to="mailto:info@xtremeworkplace.in"
                    className="text-gray-700 hover:bg-gray-900 hover:text-amber-700 px-3 py-2 rounded-md text-sm font-medium"
                  >
                   Email Support
                  </Link>
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                type="button"
                className="bg-gray-900 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-amber-700 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-white"

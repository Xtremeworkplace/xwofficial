            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <Link to="/estore"
                    className=" hover:bg-gray-800 text-white px-3 py-2 rounded-md text-sm font-medium"
                  >
                    Estore
                  </Link>
          ...
          {(ref) => (
            <div className="md:hidden" id="mobile-menu">
              <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <Link to="/estore"
                  className="hover:bg-gray-800 text-white block px-3 py-2 rounded-md text-base font-medium"
                >
                  Estore
                </Link>
